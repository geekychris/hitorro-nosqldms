...
public class DocumentService {
    ...
    public Document create(CreateRequest req) throws IOException {
        ...
        d.typeName    = req.typeName != null ? req.typeName : req.contentType;
        if (req.typeFields != null) d.typeFields.putAll(req.typeFields);
    ...
    public Document checkIn(CheckInRequest req) throws IOException {
        ...
        nu.typeName    = req.typeName    != null ? req.typeName    : head.typeName;
        // Typed fields: merge — previous head's fields carry forward,
        // fields in the request replace by key.
        nu.typeFields.putAll(head.typeFields);
        if (req.typeFields != null) nu.typeFields.putAll(req.typeFields);
