...
public class CheckInRequest {
    ...
    /** Optional — override type on this new version. Rare; usually null. */
    public String typeName;
    /** Merged with the previous head's typeFields (fields present here replace,
     *  fields absent are inherited). Pass an empty map to clear all typed fields. */
    public java.util.Map<String, Object> typeFields;
