...
public final class DmsContext implements AutoCloseable {
    ...
    public TypeRegistry    typeRegistry()    { return typeRegistry; }
    ...
    public static final class Builder {
        ...
        /** Overlay user-supplied type defs from a directory on top of the bundled ones. */
        public Builder withTypesDir(Path dir)           { this.typesDir = dir; return this; }
